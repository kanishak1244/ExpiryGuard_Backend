...
router = APIRouter(prefix="/api/gst", tags=["GST Filing Due Date Reminders"])
...
@router.get("/status")
def get_gst_status(
    current_user: models.User = Depends(crypto_utils.get_current_user),
    ...
    # Check which returns are already filed
