  ...
  return (
    <section className="py-16 sm:py-20 bg-[#F5F4EF] border-t border-b border-[#DCDDD5]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="my-9 sm:my-11 flex items-center justify-center gap-4">
          <div className="h-px bg-[#DCDDD5] flex-1 max-w-xs" />
          <span className="px-3.5 py-1 rounded-full bg-[#EDECE6] border border-[#DCDDD5] text-xs font-mono text-[#526B5A] uppercase tracking-wider font-medium">
