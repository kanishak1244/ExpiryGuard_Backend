...
/* ==========================================================================
   8. ISOLATED MOBILE COMPONENT HANDLERS
   ========================================================================== */
document.addEventListener('DOMContentLoaded', () => {
  initMobileComponentHandlers();
});

function initMobileComponentHandlers() {
  ...
  const mobileForm = document.getElementById('mobile-pilot-lead-form-modal');
